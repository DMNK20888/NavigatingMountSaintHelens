...
from AIModule import StupidAI, Dijkstras, AStarExp
...
class Map():
	...
	def __init__(self, length, width, start, goal, seed=None, filename=None, cost_function='exp'):
	...
	def createImage(self, path):
		...
		nodesExplored = len(self.explored) + len(path)
		...
		plt.show()
		return self.calculatePathCost(path), nodesExplored
		#NEED   path_img_x, path_image_y, imshow(img), imshow(explored),  
